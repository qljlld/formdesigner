...
// ***************************** END OF PLACEHOLDERS FOR NATURAL DOCS *************************************************
	...
	var jsPlumb = new jsPlumbInstance();//qiu
...
// ********************************* CANVAS RENDERERS FOR CONNECTORS AND ENDPOINTS *******************************************************************
	...
	var CanvasMouseAdapter = function() {
	    ...
	    var _mouseover = false; window._mouseDown = false; var _posWhenMouseDown = null, _mouseWasDown = false,
...
a=f/2*Math.sin(d);f=f/2*Math.cos(d);return[{x:b.point.x+f,y:b.point.y+a},{x:b.point.x-f,y:b.point.y-a}]},locationAlongCurveFrom:function(a,b,f){return q(a,b,f).location}}})();llColor = jsPlumbUtil.convertStyle(style.fillStyle, true);
			styleToWrite["fillcolor"] = fillColor;
			_maybeSetOpacity(styleToWrite, fillColor, "fill", component);
		}
		else styleToWrite["filled"] = "false";
