			...
			*/
			...
			if (jsPlumb.CurrentLibrary.isDragSupported(_element)) {
				...
				// one or more connections.
                    ...
                    //if (ui.draggable[0].className.indexOf("VM ui-draggable") >= 0) {
                    //    if (operate.length < 6) {
                    //        operate.push({ bindEvent: "drag", bindObject: ui, bind: "VM", result: "dragVM" });
                    //    }
                    //    else {
                    //        operate.shift();
                    //        operate.push({ bindEvent: "drag", bindObject: ui, bind: "VM", result: "dragVM" });
                    //    }
                    //}
                    //else if (ui.draggable[0].className.indexOf("BU ui-draggable") >= 0) {
                    //    if (operate.length < 6) {
                    //        operate.push({ bindEvent: "drag", bindObject: ui, bind: "BU", result: "dragBU" });
                    //    }
                    //    else {
                    //        operate.shift();
                    //        operate.push({ bindEvent: "drag", bindObject: ui, bind: "BU", result: "dragBU" });
...
a=f/2*Math.sin(d);f=f/2*Math.cos(d);return[{x:b.point.x+f,y:b.point.y+a},{x:b.point.x-f,y:b.point.y-a}]},locationAlongCurveFrom:function(a,b,f){return q(a,b,f).location}}})();SetOpacity(styleToWrite, strokeColor, "stroke", component);
			styleToWrite["strokeweight"] = style.lineWidth + "px";
		}
		else styleToWrite["stroked"] = "false";
