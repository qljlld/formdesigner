(function(window, undefined) {
	formdesigner.plugins.add('HiddenInput', (function() {
		$(document).ready(function() {
			var controlType = formdesigner.getConfig({}, "ControlType");
			if(controlType['HiddenInput']) {
				var _plugin = "<li class='left_li'>" + "<img class='img_text' src='images/hidden.png' />HiddenInput</li>";
		...
		var hiddenInputField = {
			addField: function(field) {
				...
				var item = "<div class=\"control\" parentControl=\"" + field.Container + "\" controlType=\"" + "HiddenInput" + "\"  style=\"position:absolute;z-index:10;border:1px solid #AAA;width:240px;height:25px;left:" + field.X + "px;top:" + field.Y + "px;" + field.CustomStyle + "\"id=\"" + field.Name + "\"><div style='float:left;height:25px;line-height:25px;'><label >控件名：</label></div><div style='float:left;'><input type='text'  id=\"" + field.Name + "HiddenInput\" style=\"height:20px;width:170px\"></input></div></div>";
