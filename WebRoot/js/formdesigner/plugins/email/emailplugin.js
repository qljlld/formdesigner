(function(window, undefined) {
	formdesigner.plugins.add('Email', (function() {
		$(document).ready(function() {
			var controlType = formdesigner.getConfig({}, "ControlType");
			if(controlType['Email']) {
				var _plugin = "<li class='left_li'>" + "<img class='img_text' src='images/email.png' />Email</li>";
