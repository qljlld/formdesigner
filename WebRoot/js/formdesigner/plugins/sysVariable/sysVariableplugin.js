(function(window, undefined) {
	formdesigner.plugins.add('SysVariable', (function() {
		$(document).ready(function() {
			var controlType = formdesigner.getConfig({}, "ControlType");
			if(controlType['SysVariable']) {
				var _plugin = "<li class='left_li'>" + "<img class='img_text' src='images/sysInput.png' />SysVariable</li>";
				var _pluginType = "quicktype";
				$("." + _pluginType).append(_plugin);
			}
		});
		var sysVariableField = {
			addField: function(field) {
				...
				var item = "<div class=\"control\" parentControl=\"" + field.Container + "\"" + "controlType='SysVariable'" + "style=\"position:absolute;z-index:10;border:1px solid #AAA;width:240px;height:25px;" + "left:" + field.X + "px;top:" + field.Y + "px;" + field.CustomStyle + "\"id=\"" + field.Name + "\">" + "<div style='float:left;height:25px;line-height:25px;'>" + "<label >" + field.Text + "</label></div><div style='float:left;'>" + "<input type='text'  id=\"" + field.Name + "textbox\" style=\"height:100%;width:100%\">" + "</input></div></div>";
