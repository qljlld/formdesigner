(function(window, undefined) {
	formdesigner.plugins.add('DatePicker', (function() {
		$(document).ready(function() {
			var controlType = formdesigner.getConfig({}, "ControlType");
			if(controlType['DatePicker']) {
				var _plugin = "<li class='left_li'>" + "<img class='img_text' src='images/date.png' />DatePicker</li>";
		...
		var dataPickerField = {
			addField: function(field) {
				//BASE.addScript("js/datePicker/WdatePicker.js");
				var item = "<div class=\"control\" parentControl=\"" + field.Container + "\" controlType=\"" + "DatePicker" + "\"  style=\"position:absolute;z-index:10;border:1px solid #AAA;width:240px;height:25px;left:" + field.X + "px;top:" + field.Y + "px;" + field.CustomStyle + "\"id=\"" + field.Name + "\"><div style='float:left; height:25px;line-height:25px;'><label>时间：</label></div><div style='float:left;'><input data-bind=\"value:DefaultValue\" type='text' id=\"" + field.Name + "date\"  class=\"Wdate\" style=\"height:20px;width:197px\" onfocus='WdatePicker()'/></div></div>";
