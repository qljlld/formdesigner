(function(window, undefined) {
	formdesigner.plugins.add('ChooseBox', (function() {
		$(document).ready(function() {
			var controlType = formdesigner.getConfig({}, "ControlType");
			if(controlType['ChooseBox']) {
				var _plugin = "<li class='left_li'>" + "<img class='img_text' src='images/Combox.png' />ChooseBox</li>";
		...
		var textBoxField = {
			addField: function(field) {
				//var item = "<div class=\"control\" controlType=\"TextBox\" " + "id=\"" + id + "\"" + "style=\"position:absolute; z-index: 10; border:1px solid #AAA;" + "width:240px;height:25px;left:" + itemleft + "px;top:" + itemtop + "px;\">" + "<div style='float:left;height:25px;line-height:25px;'>" + "<label >控件名：</label></div><div style='float:left;'>" + "<input type='text'  id=\"" + id + "textbox\" " + "style=\"height:20px;width:184px\"></input></div></div>";
				 var item = "<div class=\"control\" parentControl=\"" + field.Container + "\" controlType=\"" + "ChooseBox" + "\"  style=\"position:absolute; z-index: 10; border:1px solid #AAA;width:240px;height:25px;left:" + field.X + "px;top:" + field.Y + "px;" + field.CustomStyle + "\"id=\"" + field.Name + "\"><div style='float:left;height:25px;line-height:25px;'><label >控件名：</label></div><div style='float:left;'><input type='text' id=\"" + field.Name + "choosebox\" readonly='readonly' style=\"height:20px;width:184px;cursor:pointer;background:url(images/Combox.png) no-repeat right\"></input></div></div>";
