formdesigner.dialogs.add('ChooseBox', (function() {
    function initEvent(controlID) {
        $("#configure_tabs").tabs();
        $("#save").button().click(function(event) {
            event.preventDefault();
            var controlType = "ChooseBox";
