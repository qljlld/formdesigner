(function(window, undefined) {
	formdesigner.plugins.add('DropDownList', (function() {
		$(document).ready(function() {
			var controlType = formdesigner.getConfig({}, "ControlType");
			if(controlType['DropDownList']) {
				var _plugin = "<li class='left_li'>" + "<img class='img_text' src='images/dropdown.png' />DropDownList</li>";
